# -*- coding: utf-8 -*-
#
# OPengine documentation build configuration file, created by
...
import sphinx_opifex_theme

html_theme = "sphinx_opifex_theme"

html_theme_path = [sphinx_opifex_theme.get_html_theme_path()]